...
```text
Вход (запрос, организация)
↓
Baseline / быстрая проверка
↓
Быстрая LLM-оценка
↓
Проверка уверенности
↓
ReAct-агент (при необходимости)
↓
...
## Инструменты агента (External Context)
В рамках agent-based пайплайна используются внешние инструменты
для расширения контекста и повышения качества решений:

- **SERP** — для симуляции поискового контекста и проверки
  релевантности в условиях реального поиска
- **Tavily** — retrieval-инструмент для получения дополнительной
  информации об организациях и пользовательских запросах
...
- Метрика: **accuracy**
- Лучший результат: **~0.775 accuracy**
